# Contributing to otters
First off, thank you for considering contributing to otters. 
It's people like you that make otters great!
...
```bash
git clone https://github.com/cryptopatrick/otters.git
cd otters
```
...
To run otters, piping the output into [bunyan](https://github.com/LukeMathWalker/bunyan) to format outputted the structured logs:
...
2. [Submit a pull request](https://github.com/cryptopatrick/otters/pulls) to the original repository.
...
## Reporting Issues
Please use the [issue tracker](https://github.com/cryptopatrick/otters/issues) to report any bugs or request new features.
...
Thank you for contributing to otters!
